...
const MACRO_ITEMS = [
  ...
  { id: "rrg-engine", label: "RRG Sector Rotation", icon: Shuffle, desc: "Relative Rotation Graph" },
  { id: "country-liquidity", label: "Country Liquidity", icon: Globe, desc: "15 Major Economies" },
  { id: "country-cockpit", label: "Economic Cockpit", icon: Activity, desc: "Macro Health Diagnostics" },
  { id: "cross-border-matrix", label: "Cross-Border Matrix", icon: ArrowRightLeft, desc: "Global Capital Routing" },
