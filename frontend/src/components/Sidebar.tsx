...
const MACRO_ITEMS = [
  { id: "apex-predictor", label: "Apex Lead Predictor", icon: Zap, desc: "World Lead Engine" },
  { id: "global-flow-board", label: "Global Flow Board", icon: Globe, desc: "Macro Capital Flows" },
  { id: "country-liquidity", label: "Country Liquidity", icon: Globe, desc: "15 Major Economies" },
  { id: "central-banks", label: "Central Bank Monitor", icon: Landmark, desc: "Balance Sheets & M2" },
  ...
  { id: "asset-bull-radar", label: "Asset Bull Radar", icon: Target, desc: "Multi-Asset Radar" },
  { id: "liquidity-transmission", label: "Transmission Lab", icon: Network, desc: "Credit Channels" },
  { id: "smart-money", label: "Smart Money Exit", icon: Shield, desc: "Insider & Capital Drain" },
];
    ...
    <aside className="w-[260px] bg-[#0b0d14] border-r border-gray-800/60 flex flex-col justify-between h-screen sticky top-0 shrink-0 select-none">
      <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="px-3 py-3 space-y-4 overflow-y-auto flex-1 custom-scrollbar">
          {/* Section 1: Indian Quant Platform */}
          <div>
          ...
          {/* Section 2: Global Macro Systems */}
